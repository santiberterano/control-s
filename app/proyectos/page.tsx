...
import Ribbon from "./[id]/componentes/Ribbon";
import VistaItems from "./[id]/componentes/VistaItems";
import VistaManoDeObra, {
  type ManoDeObra,
} from "./[id]/componentes/VistaManoDeObra";
import VistaEquipos, {
  type Equipo,
} from "./[id]/componentes/VistaEquipos";
import VistaSubcontratos, {
  type Subcontrato,
} from "./[id]/componentes/VistaSubcontratos";
import VistaConstantes, {
  type Constante,
} from "./[id]/componentes/VistaConstantes";
import type { RecursoCalculable } from "./[id]/componentes/calculosRecursos";
import { useEstadoPersistido } from "./[id]/componentes/useEstadoPersistido";
...
export default function ProyectoPage() {
   ...
   * Más adelante vendrán de la biblioteca del proyecto.
   */
    ...
    <main className="min-h-screen bg-[#f4f4f2]">
      ...
      <section className="px-6 pb-10 pt-[125px]">
        <div className="mx-auto max-w-[1600px]">
          ...
          {/* SECCIONES TODAVIA NO DESARROLLADAS */}
